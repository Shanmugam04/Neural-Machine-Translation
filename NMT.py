...
if __name__ == '__main__':
    ...
    TRAIN_PATH = ['Data/English_Vietnam/Train/train.en.txt',
                  'Data/English_Vietnam/Train/train.vi.txt']
    VOCAB_PATH = ['Data/English_Vietnam/Vocabulary/vocab.en.txt',
                  'Data/English_Vietnam/Vocabulary/vocab.vi.txt']
    TEST_PATH = ['Data/English_Vietnam/Test/tst2013.en.txt',
                 'Data/English_Vietnam/Test/tst2013.vi.txt']
    
    model_name = 'English-Vietnam'
